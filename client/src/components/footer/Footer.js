            ...
            <div className='h-[407px] w-full bg-gray-900 flex items-center justify-center text-white text-[13px]'>
                <div className='w-main flex'>
                    <div className='flex-2 flex flex-col gap-2'>
                        ...
                        <span>
                            <span>Address: </span>
                            <span className='opacity-70'>48 TO HUU , TRUNG VAN , NAM TU LIEM , HA NOI</span>
                        </span>
                        <span>
                            <span>Phone: </span>
                            <span className='opacity-70'>(+03)45678910</span>
                        </span>
                        <span>
                            <span>Mail: </span>
                            <span className='opacity-70'>ducanhsupport@digital.com</span>
                        </span>
